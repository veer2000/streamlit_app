...
#                         st.selectbox(options=user_priority_drop_down_list, label="Priority1",
#                                      label_visibility="collapsed", key="priority1", on_change=mark_change)
#             with st.container(border=True, height=70, width=900, horizontal_alignment='center'):
#                 content_user, content_dropdown, _ = st.columns([0.5, 0.5, 0.1])
#                 with content_user:
#                     st.write("Priority 2")
...
#                         st.selectbox(options=user_priority_drop_down_list, label="Priority2",
#                                      label_visibility="collapsed", key="priority2", on_change=mark_change)
#             with st.container(border=True, height=70, width=900, horizontal_alignment='center'):
#                 content_user, content_dropdown, _ = st.columns([0.5, 0.5, 0.1])
#                 with content_user:
#                     st.write("Priority 3")
...
#                         st.selectbox(options=user_priority_drop_down_list, label="Priority3",
#                                      label_visibility="collapsed", key="priority3", on_change=mark_change)
